...
def calculate_loss(results_df: pd.DataFrame, w_meta: float, w_water: float) -> float:
    """
    ...
    total_loss = (w_meta * l_meta) + (w_water * l_water)
    return total_loss
...
def objective(
    ...
    total_loss = calculate_loss(results_df, w_meta, w_water)
